...
export class AddChecklist1767697112593 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        // Create checklists table with SERIAL (not UUID)
        await queryRunner.query(`CREATE TABLE "checklists" ("id" SERIAL NOT NULL, "vehicle_reg_no" character varying(50) NOT NULL, "checklistDate" date NOT NULL, "isSubmitted" boolean NOT NULL DEFAULT false, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "vehicle_id" integer NOT NULL, "checked_by_id" integer NOT NULL, CONSTRAINT "PK_336ade2047f3d713e1afa20d2c6" PRIMARY KEY ("id"))`);
        ...
        // Create checklist_items table with SERIAL (not UUID)
        await queryRunner.query(`CREATE TABLE "checklist_items" ("id" SERIAL NOT NULL, "item_name" character varying(200) NOT NULL, "status" character varying(10), "remarks" text, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "checklist_id" integer NOT NULL, CONSTRAINT "PK_bae00945a1d4789bd648e583e29" PRIMARY KEY ("id"))`);
